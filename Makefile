lazfs : lazfs.o log.o util.o cache.o compress_laz.o compress_lrzip.o
	gcc -g -o lazfs lazfs.o util.o log.o cache.o compress_laz.o compress_lrzip.o `pkg-config fuse --libs` -llas_c -llrzip
...
compress_lrzip.o: compress_lrzip.h compress_lrzip.c
	gcc -g -Wall `pkg-config fuse --cflags` -c compress_lrzip.c
